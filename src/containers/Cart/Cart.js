    ...
    return (
        <div className="card">
            <div className="card-header d-flex justify-content-between">
                <div>
                    <CartIcon /> <span className="text-primary">{props.cart.foods.length} {props.cart.foods.length > 1 ? 'ITEMS' : 'ITEM'}</span>
                </div>
                <Button cls="btn border border-secondary text-secondary p-1"
                    title="Close" clicked={() => props.history.goBack()} />
            </div>
            ...
            <div className="card-body">
                ...
                <CartItem
                    items={props.cart.foods} />

                <div className="card-footer d-flex justify-content-between">
                    <Button cls="btn btn-success mr-4 text-white p-1"
                        title="Add More" clicked={() => props.history.goBack()} />
